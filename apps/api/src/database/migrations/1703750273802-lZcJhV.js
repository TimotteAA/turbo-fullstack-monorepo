...
class LZcJhV1703750273802 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`message_receiver\` ADD CONSTRAINT \`FK_5cf8dfb72b6f317f82c893b3414\` FOREIGN KEY (\`receiverId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`message_receiver\` ADD CONSTRAINT \`FK_5a0a4189a812ec5269f2155deb9\` FOREIGN KEY (\`messageId\`) REFERENCES \`messages\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`message_receiver\` DROP FOREIGN KEY \`FK_5a0a4189a812ec5269f2155deb9\``);
        await queryRunner.query(`ALTER TABLE \`message_receiver\` DROP FOREIGN KEY \`FK_5cf8dfb72b6f317f82c893b3414\``);
